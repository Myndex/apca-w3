...
These define the basic minimum levels, what you might think of as AA in the old WCAG&nbsp;2. For the equivalent to AAA, simply increase the contrast values by L<sup>c</sup>&nbsp;15.
